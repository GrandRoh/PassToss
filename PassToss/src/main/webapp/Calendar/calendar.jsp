			 ...
			 eventClick: function (arg){
                 ...
                 $(function deleteData(){
                     $.ajax({
                         ...
                         dataType: "json",
                         data: {     'alldata': JSON.stringify(obj)},
...
<body>
	...
	<div id='external-events'
		...
		<div
			class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
			<div class='fc-event-main' style="background-color: blue">회의(팀)</div>
		</div>
		<div
			class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
			<div class='fc-event-main' style="background-color: green">회의(본부)</div>
		</div>
		<div
			class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
			<div class='fc-event-main' style="background-color: black">컨퍼런스콜</div>
		</div>
		<div
			class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
